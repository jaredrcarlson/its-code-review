...
Basic project structuring was achieved with the **bcw-create express-vue** tool (basic full-stack structure with Express, Vue, and Auth0). From there, I built **Tower** independently as my first full-stack project.  

This project shows my ability to **take API requirements, build relational models, and enforce business rules** across backend and frontend layers.

Highlights:
- Implemented **Node.js/Express API** with **MongoDB (Mongoose)** models  
- Designed and built relationships for **Events, Tickets, Accounts, and Comments** (one-to-many and many-to-many)  
- Added **Auth0 authentication** and enforced ownership rules (e.g., users can only modify/cancel their own events)  
- Built **Vue** frontend with event creation, detail pages, capacity tracking, and comment threads  
- Ensured business rules (capacity counts, ticket cancellation, event privacy) were correctly enforced in both UI and backend  
- Created **Postman API testing suite**, improving endpoint development, testing, and secure coding practices
